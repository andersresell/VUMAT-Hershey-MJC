...
Part of the source files can be viewed in subroutine directory. For a complete version of the code, as well as a detailed report covering the theory, visit [caeassistant.com](https://caeassistant.com/product/modified-johnson-cook-viscoplastic-model-hershey-yield-surface/)
...
The various constants are breifly explained below, but it is adviced to read the corresponding report (at [caeassistant.com](https://caeassistant.com/product/modified-johnson-cook-viscoplastic-model-hershey-yield-surface/)) for more detail.
- E - youngs modulus
- nu - poisson ratio
